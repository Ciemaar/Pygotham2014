...
risk_by_portfolio = DataFrame(
    ((portfolio.name, portfolio.price(funds, market, model, cob_date), portfolio.hVar(funds, market, model, cob_date))
     for portfolio in portfolios), columns=['portfolio_name', 'price', 'hVar'])
